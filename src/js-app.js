...
function ocmCompare(){
  ...
  function buildAnalysis(offer,comp,other,otherComp,label,otherLabel){
    ...
    // PTO
    if(offer.pto>other.pto) pros.push('\ud83c\udfd6\ufe0f More time off: '+offer.pto+' days vs '+other.pto+' \u2014 '+(offer.pto-other.pto)+' extra days matters for longevity and burnout');
