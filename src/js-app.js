...
function csbStageChange(){
  ...
  if(isFellow||isAttending){
    ...
    h+='<option value="ortho">Orthopedic Surgery</option><option value="nsurg">Neurosurgery</option><option value="derm">Dermatology</option>';
    h+='<option value="ophtho">Ophthalmology</option><option value="rads">Radiology</option><option value="gen_surg">General Surgery</option>';
    h+='<option value="em">Emergency Medicine</option><option value="fm">Family Medicine</option><option value="psych">Psychiatry</option>';
    h+='</select></div>';
  }
