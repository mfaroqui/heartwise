...
function csbStageChange(){
  ...
  var detail=document.getElementById('csb-detail-fields');
  if(!now){if(detail)detail.style.display='none';return}
  if(detail)detail.style.display='';
  var showBoards=now!=='fellow'&&now!=='attending';
  var showAways=now==='ms3'||now==='intern'||now==='resident'||now==='senior';
  var showPS=now!=='fellow'&&now!=='attending';
  var showClinical=now!=='ms1';
  var showSetting=now==='fellow'||now==='attending';
  var el;
  el=document.getElementById('csb-boards-section');if(el)el.style.display=showBoards?'':'none';
  el=document.getElementById('csb-away-section');if(el)el.style.display=showAways?'':'none';
  el=document.getElementById('csb-ps-section');if(el)el.style.display=showPS?'':'none';
  el=document.getElementById('csb-clinical-section');if(el)el.style.display=showClinical?'':'none';
  el=document.getElementById('csb-setting-section');if(el)el.style.display=showSetting?'':'none';
}
function csbUpdate(){}
function csbGenerate(){
  ...
  if(now==='ms1'||now==='ms2'){
    ...
    if(firstAuth===0)p2.push('Start a first-author research project \u2014 highest ROI activity for your application');
    p2.push('Take on a leadership position in a relevant organization');
    if(isCompetitive)p2.push('Begin Step 1 preparation early \u2014 a strong score opens doors');
    ...
    if(firstAuth===0)p1.push('Start a first-author project immediately \u2014 case report has fastest turnaround (2-4 months)');
    ...
    phases.push({time:'6 \u2013 12 months',title:'Application Season',items:[
      ...
      'Prepare with Mock Interview Simulator \u2014 practice 3+ full sessions',
    ...
    if(firstAuth===0){
      p1.push('Research is your biggest gap. Start a first-author project THIS MONTH.');
    ...
    if(urgency==='1'){
      ...
      phases.push({time:'6 \u2013 9 months',title:'Interview & Match',items:[
        ...
        'Mock Interview Simulator \u2014 practice 3+ full sessions',
        'Send targeted interest emails after each interview',
        'Rank by where you\'d be happiest for 3+ years, not prestige',
      ...
      phases.push({time:'12 \u2013 18 months',title:'Application Year',items:[
        'Submit competitive ERAS with strong research and specialty-specific letters',
        ...
        'Interview broadly but prepared \u2014 know each program before you walk in',
    ...
    phases.push({time:'6 \u2013 12 months',title:'Contract Negotiation',items:[
      'Run every offer through the Contract Intelligence Tool',
      'Compare offers using the Offer Comparison Matrix',
      'Negotiate with data: MGMA percentiles, regional benchmarks, call frequency, tail coverage',
      ...
      'Financial Trajectory Simulator \u2014 see 30-year impact of each option'
    ]});
    ...
    phases.push({time:'Now \u2013 3 months',title:'Strategic Assessment',items:[
      ...
      'Benchmark compensation: RVU Calculator + MGMA comparison',
      ...
      'Run the Financial Trajectory Simulator to see long-term wealth trajectory'
    ]});
    phases.push({time:'3 \u2013 6 months',title:'Build Your Plan',items:[
      ...
      'If pivoting: understand retraining requirements, credentialing, timeline',
    ...
    phases.push({time:'6 \u2013 12 months',title:'Execute the Transition',items:[
      ...
      'Negotiate next position using data and the Contract Intelligence Tool',
      'Set up financial safeguards: emergency fund, moonlighting if needed',
      'Consider a Strategic Audit for Dr. Faroqui\'s personalized assessment',
  ...
  var concernAdvice={
    ...
    direction:'Get data, not more opinions. Shadow in 2-3 specialties. Ask attendings 5-10 years in: "What do you wish you knew?" Run the Specialty Fit Analyzer.',
    ...
    finance:'Run the Financial Trajectory Simulator. Factor in training length, debt, geography, and practice type differences. Career and financial decisions are inseparable.',
