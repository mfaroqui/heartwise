...
const VAULT_CONTENT={
v1:`<h3>Fellowship Readiness Worksheet</h3>
<p style="color:var(--text3);font-size:12px;margin-bottom:16px">Score yourself honestly. This isn't about feeling good — it's about knowing where you stand.</p>
<div style="font-size:13px">
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>1. Research & Scholarly Activity</strong> (Target: 4+/5)<br><span style="color:var(--text3);font-size:11px">Publications, abstracts, presentations. For competitive subspecialties: 2-3 first-author papers expected.</span></div>
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>2. Letters of Recommendation</strong> (Target: 4+/5)<br><span style="color:var(--text3);font-size:11px">Specialty-specific, from physicians who know your work. A strong letter from a known name > 5 generic ones.</span></div>
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>3. Clinical Performance</strong> (Target: 4+/5)<br><span style="color:var(--text3);font-size:11px">Evaluations, rotation feedback, procedural skills. How would attendings describe your clinical judgment?</span></div>
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>4. Board Scores / ITE</strong> (Target: 3+/5)<br><span style="color:var(--text3);font-size:11px">Screening tool — above the cutoff matters more than exact number.</span></div>
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>5. Leadership & Service</strong> (Target: 3+/5)<br><span style="color:var(--text3);font-size:11px">Chief resident, committee roles, QI projects, teaching.</span></div>
<div style="padding:10px 0;border-bottom:1px solid var(--border)"><strong>6. Networking & Away Rotations</strong> (Target: 3+/5)<br><span style="color:var(--text3);font-size:11px">Program visits, conference attendance, faculty connections at target programs.</span></div>
<div style="padding:10px 0"><strong>7. Personal Statement</strong> (Target: 4+/5)<br><span style="color:var(--text3);font-size:11px">Clear, specific story. Why this specialty? Why you? Polished through multiple drafts.</span></div>
</div>
<div style="padding:16px;background:var(--bg2);border-radius:8px;margin-top:16px"><p style="font-size:12px;color:var(--text2);line-height:1.6;margin:0"><strong>Score Guide:</strong> 28-35 = Strong (focus on fit). 21-27 = Solid with gaps (address weakest 2 now). 14-20 = Needs work (consider timeline adjustment). Below 14 = Honest reassessment needed.</p></div>
<p style="font-size:10px;color:var(--text3);margin-top:12px;font-style:italic">Based on NRMP Charting Outcomes and program director surveys.</p>`,
